...
import com.termux.app.extrakeys.ExtraKeysManagerBottomSheet;
import com.termux.app.quickcommands.QuickCommandsBottomSheet;
...
public class TermuxTerminalExtraKeys extends TerminalExtraKeys {
    ...
    private void openFileManager() {
        mActivity.startActivity(new Intent(mActivity, com.termux.app.filebrowser.FileBrowserActivity.class));
    }
    ...
    public void onTerminalExtraKeyButtonClick(View view, String key, boolean ctrlDown, boolean altDown, boolean shiftDown, boolean fnDown) {
        if ("KEYBOARD".equals(key)) {
            ...
            androidx.viewpager.widget.ViewPager pager = mActivity.getTerminalToolbarViewPager();
            if (pager != null) {
                pager.setCurrentItem(pager.getCurrentItem() == 0 ? 1 : 0, true);
            }
        } else if ("COMMANDS".equals(key)) {
            new QuickCommandsBottomSheet().show(mActivity.getSupportFragmentManager(), "quick_commands");
        } else if ("SETTINGS".equals(key)) {
            new ExtraKeysManagerBottomSheet().show(mActivity.getSupportFragmentManager(), "extra_keys_manager");
        } else {
